  ...
  while (idx < len) {
    ...
    if (nullptr != key_value_pair) {
      if (Runtime::runtimeFeatureEnabled(
        ...
        ProtobufWkt::Any typed_metadata_value;
        ProtobufWkt::BytesValue metadata_value;
        metadata_value.set_value(tlv_value.data(), tlv_value.size());
        typed_metadata_value.PackFrom(metadata_value);
        ...
        metadata[key_value_pair->key()] = typed_metadata_value;
      } else {
