...
AllocatorManager::AllocatorManager(Api::Api& api, Envoy::Stats::Scope& scope,
      ...
      RELEASE_ASSERT((bytes_to_release_ == 0 || memory_release_interval_msec_ > std::chrono::milliseconds(0)), "Memory releasing is not supported for gperf tcmalloc."); 
    #endif
