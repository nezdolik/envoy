...
inline HostSharedPtr makeTestHost(ClusterInfoConstSharedPtr cluster, const std::string& url, TimeSource& time_source,
...
inline HostSharedPtr makeTestHost(ClusterInfoConstSharedPtr cluster, const std::string& url,
                                  const envoy::config::core::v3::Metadata& metadata, TimeSource& time_source,
                                  uint32_t weight = 1) {
  return HostSharedPtr{
...
makeTestHost(ClusterInfoConstSharedPtr cluster, const std::string& url,
             const envoy::config::endpoint::v3::Endpoint::HealthCheckConfig& health_check_config, TimeSource& time_source,
             uint32_t weight = 1) {
