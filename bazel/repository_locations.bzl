...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_jemalloc_jemalloc = dict(
        project_name = "jemalloc",
        project_desc = "general purpose malloc(3) implementation",
        ...
        urls = ["https://github.com/jemalloc/jemalloc/archive/{version}.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
        release_date = "2022-05-26",
        cpe = "N/A",
        license = "Facebook, Inc",
        license_url = "https://github.com/jemalloc/jemalloc/blob/{version}/LICENSE",
    ),
